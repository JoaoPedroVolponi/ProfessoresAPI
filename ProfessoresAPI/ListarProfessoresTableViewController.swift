...
class ListarProfessoresTableViewController: UITableViewController {
    ...
    */
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        var teste = storyboard?.instantiateViewController(withIdentifier: "testestory") as! ViewController
        teste.teste1 = professores[indexPath.row]
        teste.index = professores[indexPath.row].id!
